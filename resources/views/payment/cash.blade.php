        ...
        <div class="payment-wrapper">
            <div class="payment-total">
                ...
                <h4 id="total" style="font-weight: 700;color:red;">
                    {{ rupiah($sale_erp->sale->grand_total) }}
                ...
                <div class="payment-note">
                    Terima kasih telah melakukan transaksi, silahkan menunggu<br/> untuk dipanggil oleh kasir
                </div>
            </div>
            @if (!in_array($sale_erp->sale->payment_status, ['Paid', 'Expired', 'Due']) && $order->pickup == 'Indoprinting Durian')
                <form action="{{ route('change.payment') }}" method="POST" id="myForm" style="margin-bottom: 20px;margin-top:60px;">
                    ...
                    <center><a href="javascript:void(0);" class="metode" id="submit">Ganti metode pembayaran ke <b>Transfer</b> ?</a></center>
                </form>
            @endif
